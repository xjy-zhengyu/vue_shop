	...
	<div>
		...
		<el-card>
			<el-row :gutter="20">
				...
				<el-col :span="4"><div><el-button type="primary" @click="addDialogVisible = true">添加用户</el-button></div></el-col>
			</el-row>
    ...
    return {
      ...
      addFormRules: {
        ...
        email: [
          ...
          // validator自定义验证规则
          { validator: checkEmail, trigger: 'blue' }
        ],
        mobile: [
          { required: true, message: '请输入手机号', trigger: 'blur' },
          { validator: checkMobile, trigger: 'blue' }
        ]
      },
      // 控制修改用户对话框的显示隐藏
  ...
  methods: {
    ...
    async userStateChanged (userInfo) {
      ...
      if (res.meta.status !== 200) {
        ...
        return this.$message.erroe('获取用户状态失败！')
      } else {
    ...
    async removeUserById (id) {
      ...
      if (confirmResult !== 'confirm') {
        ...
        return this.$message.info('已成功删除用户')
      }
    }
  }
}
